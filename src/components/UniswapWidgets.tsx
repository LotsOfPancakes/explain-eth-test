...
export const UniswapSwapInterface: React.FC = () => {
  const ethLogo = 'https://s2.coinmarketcap.com/static/img/coins/64x64/1027.png'; // ETH logo
  const usdtLogo = 'https://s2.coinmarketcap.com/static/img/coins/64x64/825.png'; // USDT logo
