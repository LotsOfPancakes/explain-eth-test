...
export const WalletBalance: React.FC<{ eth: number; usdt?: number }> = ({
  eth,
  usdt,
}) => (
...
export const UniswapSwapAndBalance: React.FC = () => {
  const [balance, setBalance] = useState<{ eth: number; usdt: number }>({
    eth: 2,
    usdt: 0,
  });
  ...
  const handleSwapComplete = () => {
    ...
    if (isEthToUsdt) {
      setBalance({
        eth: balance.eth - sell,
        usdt: balance.usdt + sell * EXCHANGE_RATE,
      });
    } else {
      setBalance({
        eth: balance.eth + sell / EXCHANGE_RATE,
        usdt: balance.usdt - sell,
      });
    }
    setSellAmount("");
      ...
      <div className="space-y-4">
        <div>
          ...
          <div className="bg-[#252529] border border-[#3A3B43] rounded-lg p-3 flex items-center">
            ...
            <div className="flex items-center">
              <img
                src={isEthToUsdt ? ethLogo : usdtLogo}
        ...
        <div>
          ...
          <div className="bg-[#252529] border border-[#3A3B43] rounded-lg p-3 flex items-center">
            ...
            <div className="flex items-center">
              <img
                src={isEthToUsdt ? usdtLogo : ethLogo}
            ...
            {isSwapping ? (
              ...
              <>
                ...
                <div className="absolute inset-0 pointer-events-none">
                  ...
                  <div
                    className="confetti animate-confetti bg-red-500 w-2 h-2 rounded-full absolute left-2/5 top-0"
                    style={{ animationDelay: "0.1s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-green-500 w-2 h-2 rounded-full absolute left-3/5 top-0"
                    style={{ animationDelay: "0.2s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-yellow-500 w-2 h-2 rounded-full absolute left-4/5 top-0"
                    style={{ animationDelay: "0.3s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-purple-500 w-2 h-2 rounded-full absolute left-1/4 top-0"
                    style={{ animationDelay: "0.15s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-pink-500 w-2 h-2 rounded-full absolute left-3/4 top-0"
                    style={{ animationDelay: "0.25s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-blue-500 w-2 h-2 rounded-full absolute left-1/3 top-0"
                    style={{ animationDelay: "0.35s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-red-500 w-2 h-2 rounded-full absolute left-2/3 top-0"
                    style={{ animationDelay: "0.4s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-green-500 w-2 h-2 rounded-full absolute left-1/2 top-0"
                    style={{ animationDelay: "0.45s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-yellow-500 w-2 h-2 rounded-full absolute left-1/6 top-0"
                    style={{ animationDelay: "0.5s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-purple-500 w-2 h-2 rounded-full absolute left-5/6 top-0"
                    style={{ animationDelay: "0.55s" }}
                  ></div>
                  <div
                    className="confetti animate-confetti bg-pink-500 w-2 h-2 rounded-full absolute left-1/2 top-0"
              ...
              <span className="text-gray-300">
                Insufficient {isEthToUsdt ? "ETH" : "USDT"}
              </span>
            ) : (
              "Swap"
            )}
